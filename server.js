...
app.get('/allusers',passport.authenticate('facebook-token'), (req, res)=> {
    Profile.find()
        .sort({date:-1})
        .exec()
...
app.get('/allcollegues',passport.authenticate('facebook-token'), (req, res)=> {
...
app.get('/allusers/:userId',passport.authenticate('facebook-token'), (req, res)=> {
...
app.delete('/user', passport.authenticate('facebook-token'), (req, res)=> {
...
//post 
app.get('/allposts',passport.authenticate('facebook-token'), (req, res)=> {
...
app.post('/addpost', passport.authenticate('facebook-token'), (req, res)=> {
...
app.post('/like/:id', passport.authenticate('facebook-token'),
 (req, res)=>{
...
app.delete('/deletepost/:id', passport.authenticate('facebook-token'), (req, res)=> {
